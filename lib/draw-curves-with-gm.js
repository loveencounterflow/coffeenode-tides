...
(function() {
  ...
  module.exports = this._draw_curves_with_gm = function(route, raw_dots, handler) {
     ...
     */
    var bezier_h_dots, bezier_h_points, bezier_hl_points, bezier_l_dots, bezier_l_points, collection, dots, hl, idx, image, point, points, x0, x1, y0, y1, _i, _j, _k, _l, _len, _len1, _len2, _len3, _ref, _ref1, _ref2, _ref3, _ref4, _ref5;
    bezier_hl_points = [];
    bezier_h_dots = [];
    bezier_l_dots = [];
    bezier_h_points = [];
    ...
    y1 = this._image_px_from_y_raw(60);
    image.stroke('black', 1).drawLine(x0, y0, x1, y1);
    for (idx = _j = 0, _len1 = bezier_hl_points.length; _j < _len1; idx = ++_j) {
      _ref1 = bezier_hl_points[idx], hl = _ref1[0], points = _ref1[1];
    ...
    _ref3 = [bezier_h_points, bezier_l_points];
    for (_k = 0, _len2 = _ref3.length; _k < _len2; _k++) {
      collection = _ref3[_k];
      for (idx = _l = 0, _len3 = collection.length; _l < _len3; idx = ++_l) {
        _ref4 = collection[idx], hl = _ref4[0], points = _ref4[1];
        (_ref5 = image.stroke('black', 4)).drawBezier.apply(_ref5, points);
      }
    }
