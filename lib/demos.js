...
(function() {
  ...
  this.read_aligned_events = function() {
    ...
    return TIDES.read_aligned_events(route, (function(_this) {
      return function(error, event_batches) {
        var ap, date_txt, declination_deg, distance_ed, distance_km, extrema_event_batch, height, hl, primary_event, quarter, secondary_event, secondary_events, sn, symbol, tidal_hl_event_batch, _i, _len;
        if (error != null) {
          throw error;
        }
