...
(function() {
  ...
  this.read_aligned_events = function() {
    ...
    return TIDES.read_aligned_events(route, (function(_this) {
      return function(error, event_batches) {
        var ap, date_txt, declination_deg, distance_km, height, hl, primary_event, quarter, secondary_event, secondary_events, sn, symbol, tidal_extrema_event_batch, tidal_hl_event_batch, _i, _len, _results;
        if (error != null) {
          throw error;
        }
