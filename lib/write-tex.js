...
(function() {
  ...
  this.new_dots_image = function(hi_dots, lo_dots, image_format) {
    var method;
    if (image_format == null) {
      image_format = 'gm';
    }
    method = this["_new_dots_image_using_" + image_format];
    if (method == null) {
  ...
  this._new_dots_image_using_gm = function(hi_dots, lo_dots) {
    var R, collection, dots, height, idx, _i, _j, _len, _len1, _ref, _ref1;
    R = '';
  ...
  this._new_dots_image_using_hobby = function(hi_dots, lo_dots) {
  ...
  this.main = function() {
    var hi_dots, last_day, lo_dots, moon_quarter, route, row_idx, rows, wrote_header;
    ...
    wrote_header = false;
    echo(preamble);
    return TIDES.walk_table_rows(route, (function(_this) {
      return function(error, table_row) {
        var format, height, month_tex, year;
        if (error != null) {
          throw error;
        }
        if (table_row === null) {
          echo(TEX.rpr(_this.new_dots_image(hi_dots, lo_dots)));
          format = TEX.raw("{ r r l r q r | c | c | c }\n");
          echo(TEX.rpr(_this.new_tabular([format, rows])));
          echo(postscript);
          return;
        }
        row_idx += 1;
        if (!wrote_header) {
          ...
          month_tex = _this.format_month(table_row['date'][1]);
        ...
        if ((height = table_row['hi-water-height']) != null) {
          hi_dots.push([row_idx, height]);
        }
        if ((height = table_row['lo-water-height']) != null) {
        ...
        if (last_day === table_row['date'][2]) {
          table_row['is-new-day'] = false;
          table_row['date'] = null;
          table_row['weekday-idx'] = null;
          if (table_row['moon-quarter'] != null) {
          ...
          table_row['is-new-day'] = true;
          last_day = table_row['date'][2];
        }
        return TEX.push(rows, _this.new_row(table_row));
      };
    })(this));
  };
