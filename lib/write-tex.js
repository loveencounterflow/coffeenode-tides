...
(function() {
  var BAP, FI, TEX, TEXT, TIDES, TRM, TYPES, alert, badge, chr, cline, debug, echo, esc, fill_in, hbox, help, hline, hrule, info, leading, leavevmode, log, multicolumn, newline, next_cell, next_line, njs_fs, njs_path, postscript, preamble, read, rpr, thinspace, warn, whisper;
  ...
  if (module.parent == null) {
    ...
    debug(TIDES.options.get(fill_in('/values/moon/$quarter', {
      quarter: 0
    })));
    debug(((function() {
      var _i, _len, _ref, _results;
      _ref = FI.default_matcher.source;
      _results = [];
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        chr = _ref[_i];
        _results.push('%' + (chr.charCodeAt(0)).toString(16));
      }
      return _results;
    })()).join(''));
  }
