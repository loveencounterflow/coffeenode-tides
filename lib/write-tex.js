...
(function() {
  ...
  this.y_position_from_datetime = function(day_idx, time, module, unit) {
    var value;
    if (unit == null) {
      unit = 'mm';
    }
    ...
    value = ((day_idx * 24 + (this._as_integer(time[0]))) * 60 + this._as_integer(time[1])) * module;
  ...
  this.main = function() {
    ...
    return TIDES.walk_tidal_records(route, (function(_this) {
      return function(error, trc) {
        ...
        y_position = _this.y_position_from_datetime(day_idx, this_time, 1 / 178, 'mm');
        switch (hl = trc['hl']) {
          case 'h':
            x_position = '100mm';
            break;
        ...
        return echo("\\begin{textblock*}{15mm}[1,0.5](130mm," + y_position + ")\\flushright —\\end{textblock*}");
      };
    })(this));
  };
