...
(function() {
  var BAP, TEX, TEXT, TIDES, TRM, TYPES, alert, badge, cline, debug, echo, esc, hbox, help, hline, hrule, info, leading, leavevmode, log, multicolumn, newline, next_cell, next_line, njs_fs, njs_path, paCenter, paLeft, paRight, postscript, preamble, read, rpr, thinspace, warn, whisper;
  ...
  this.format_month_name = function(month_nr) {
    var align_x, align_y, alignment, month_name, pa_command, position_x, position_y;
    ...
    return TEX.new_group([TEX.new_loner('scFont'), TEX.new_loner('large'), TEX.new_command('paGauge', [month_name]), TEX.new_command('color', 'DarkRed'), pa_command([position_x, position_y, month_name])]);
  };
