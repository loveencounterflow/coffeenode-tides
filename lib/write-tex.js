  ...
  this.main = function() {
    ...
    return TIDES.walk_tidal_records(route, (function(_this) {
      return function(error, trc) {
        ...
        y_position = _this.y_position_from_datetime(row_idx, day_idx, this_time, 1 / 200, 'mm');
        switch (hl = trc['hl']) {
          case 'h':
            x_position = '100mm';
            break;
        ...
        return echo("\\begin{textblock*}{15mm}[1,0.5](" + x_position + "," + y_position + ")\\flushright " + this_time[0] + " : " + this_time[1] + "\\gridstrut\\end{textblock*}");
      };
    })(this));
  };
