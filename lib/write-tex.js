...
(function() {
  var BAP, TEX, TEXT, TIDES, TRM, TYPES, alert, badge, cline, d, debug, echo, esc, eventually, hbox, help, hline, hrule, info, leading, leavevmode, log, multicolumn, newline, next_cell, next_line, njs_fs, njs_path, postscript, preamble, read, rpr, thinspace, warn, whisper,
    __slice = [].slice;
