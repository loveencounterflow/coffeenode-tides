  ...
  this.main = function() {
    ...
    TIDES.read_aligned_events(route, (function(_this) {
      return function(error, event_batches) {
        var ap, ap_symbol, date, day_txt, declination_deg, distance_ed, dst, extrema_event_batch, height, hl, line_count, lunar_events, module, month_txt, moon_symbol, sn, sn_symbol, textheight, this_day, this_month, this_month_tex, tidal_event, tidal_hl_event_batch, time_txt, unit, x_position, y_position, _i, _len, _ref, _ref1, _ref2;
        if (error != null) {
          throw error;
        }
        ...
        for (_i = 0, _len = tidal_hl_event_batch.length; _i < _len; _i++) {
          ...
          /* TAINT parametrize */
          if ((date.isBefore('2014-06-13')) || (date.isAfter('2014-08-10 17:00'))) {
            continue;
          }
