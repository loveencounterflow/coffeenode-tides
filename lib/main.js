  ...
  this.walk_tidal_records = function(route, handler) {
    this.walk_tidal_raw_fields(route, (function(_this) {
      return function(error, fields, source_line, source_line_nr) {
        var Z, columns, date, date_txt, day_txt, field_count, height, height_txt, hl, hour_txt, ignored, minute_txt, month_txt, moon_phase, moon_quarter, tide, time, time_txt, xdate, year_txt, _ref, _ref1;
        if (error != null) {
          return handler(error);
        }
        if (fields === null) {
