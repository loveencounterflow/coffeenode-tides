...
(function() {
  var FI, FS, TIDES, TRM, TYPES, XDate, alert, badge, debug, echo, eventually, help, info, log, new_and_full_moons, njs_fs, njs_path, route, rpr, warn, whisper;
  ...
  this.options = FI.fill_in(require('../options'));
