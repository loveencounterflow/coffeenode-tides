...
(function() {
  var FS, TRM, TYPES, alert, badge, debug, echo, eventually, help, info, log, moment, njs_fs, njs_path, route, rpr, warn, whisper;
  ...
  this.walk_lunar_distance_events = function(route, handler) {
    return this.walk_raw_fields(route, (function(_this) {
      return function(error, fields, source_line, source_line_nr) {
        var columns, date, date_txt, details, distance_km, distance_km_txt, field_count, marker, source, time_txt, tz;
        if (error != null) {
          return handler(error);
        }
        if (fields === null) {
  ...
  this.walk_lunar_declination_events = function(route, handler) {
    return this.walk_raw_fields(route, (function(_this) {
      return function(error, fields, source_line, source_line_nr) {
        var columns, date, date_txt, declination_deg, declination_txt, details, field_count, marker, source, time_txt, tz;
        if (error != null) {
          return handler(error);
        }
        if (fields === null) {
  ...
  if (module.parent == null) {
    ...
    this.walk_lunar_distance_events(route, function(error, event) {
      if (error != null) {
        throw error;
      }
      if (event === null) {
    ...
    this.walk_lunar_declination_events(route, function(error, event) {
      if (error != null) {
        throw error;
      }
      if (event === null) {
