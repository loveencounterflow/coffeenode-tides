...
(function() {
  ...
  this.walk_tide_and_moon_events = function(route, handler) {
    var datetime_format, record_idx, timezone;
    record_idx = -1;
    ...
    this.walk_raw_fields(route, (function(_this) {
      return function(error, fields, source_line, source_line_nr) {
        var columns, date_txt, field_count, height, height_txt, hl, is_dst, last_record_idx, moon_date, moon_phase, moon_quarter, moon_time_txt, tide, tide_date, tide_time_txt;
        if (error != null) {
          return handler(error);
        }
        if (fields === null) {
  ...
  this.walk = function(route, handler) {
    ...
    return this.walk_tide_and_moon_events(route, (function(_this) {
  ...
  this._demo_walk = function() {
    ...
    TIDES = this;
    route = njs_path.join(__dirname, '../tidal-data/Vlieland-haven.txt');
    return TIDES.walk(route, function(error, event) {
