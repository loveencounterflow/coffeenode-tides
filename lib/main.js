...
(function() {
  var FS, TRM, TYPES, alert, bSearch, badge, dates, debug, echo, eventually, help, info, log, moment, njs_fs, njs_path, rpr, warn, whisper;
  ...
  this.walk_lunar_distance_events = function(handler) {
    ...
    return this.walk_raw_fields(route, (function(_this) {
      return function(error, fields, source_line, source_line_nr) {
        var date, date_txt, details, distance_km, distance_km_txt, field_count, marker, source, time_txt, tz;
        if (error != null) {
          return handler(error);
        }
        if (fields === null) {
        ...
        return handler(null, _this.new_lunar_event(source, 'distance', marker, date, details));
      };
    })(this));
  };
  ...
  this.walk_lunar_declination_events = function(handler) {
    ...
    return this.walk_raw_fields(route, (function(_this) {
      return function(error, fields, source_line, source_line_nr) {
        var date, date_txt, declination_deg, declination_txt, details, field_count, marker, source, time_txt, tz;
        if (error != null) {
          return handler(error);
        }
        if (fields === null) {
        ...
        return handler(null, _this.new_lunar_event(source, 'declination', marker, date, details));
      };
    })(this));
  };
  ...
  this._demo_walk_tide_and_moon_events = function() {
    ...
    TIDES.walk_tide_and_moon_events(route, (function(_this) {
      return function(error, event) {
        var date, date_txt, height, hl, quarter, symbol, type;
        if (error != null) {
          throw error;
        }
        if (event === null) {
  ...
  this._demo_align_tide_and_moon_events = function() {
    var TIDES, collect, get_compare, lunar_events, route, splice, tidal_events;
    TIDES = this;
  ...
  dates = [new Date('2014-10-26T00:59'), new Date('2014-10-26T01:00')];
