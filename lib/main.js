...
(function() {
  var FS, Line_by_line, TIDES, TRM, TYPES, XDate, alert, badge, debug, echo, eventually, help, info, log, njs_fs, njs_path, route, rpr, warn, whisper;
  ...
  this.walk_table_rows = function(route, handler) {
     ...
     */
    var Z, finished, last_day, last_month, last_year, over;
    finished = false;
    over = false;
    Z = null;
    last_day = null;
    ...
    this.walk_tidal_records(route, (function(_this) {
      return function(error, tidal_record) {
        var hl, moon_quarter, source_line_nr, this_date, this_day, this_month, this_year, xdate, _ref;
        if (error != null) {
          throw error;
        }
        if (over) {
        ...
        source_line_nr = (_ref = tidal_record != null ? tidal_record['source-line-nr'] : void 0) != null ? _ref : null;
        finished = tidal_record === null || source_line_nr > 150;
        finished = (tidal_record === null) || finished && !over;
        if (finished) {
          over = true;
          if (Z != null) {
            handler(null, Z);
  ...
  FS.lines_of = function(route, handler) {
